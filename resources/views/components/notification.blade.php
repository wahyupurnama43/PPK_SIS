...
<script>
    ...
    $(document).ready(function() {
        function playMusic() {
            // Gantilah URL dengan URL musik yang ingin Anda mainkan
        ...
        setInterval(() => {
            $.ajax({
                ...
                success: function(res) {
                    ...
                    res.forEach(e => {
                        let date = new Date(e.created_at).toLocaleDateString('id', {
                            day: '2-digit',
                            month: 'long',
                            year: 'numeric'
                        });
                    ...
                    $('#notif').html(html);
                    if (res.length > previousNotificationCount) {
                        playMusic();
                    }

                    // Memperbarui jumlah notifikasi sebelumnya
                    previousNotificationCount = res.length;
                },
            })
        }, 10000);
