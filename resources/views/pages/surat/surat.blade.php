                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <label for="">NB: Silakan mengisi surat sesuai dengan kebutuhan Anda, dengan menggunakan kalimat yang baik dan benar.</label>
                                </div>
                                <div class="col-6">
                                    <button class="btn btn-info mr-2 mb-2" type="button" data-toggle="modal" data-target="#view">Contoh Keterangan Bekerja</button>
                                </div>
                                <div class="col-6">
                                    <button class="btn btn-info mr-2 mb-2" type="button" data-toggle="modal" data-target="#view2">Contoh Keterangan Belum Kawin</button>
                                </div> 
                                <div class="col-6">
                                    <button class="btn btn-info mr-2 mb-2" type="button" data-toggle="modal" data-target="#view3">Contoh Keterangan Penghasilan</button>
                                </div> 
                            </div>
                        </div>
                        <div class="modal-footer">
